...
class EditDessous extends Component {
  constructor(props) {
    super(props)
    this.state = {
      dessous:[],
  ...
  updateView=()=>{
    api.getInfo("dessous")
      .then(kurse=>{
        this.setState({dessous:kurse})
      })
      .catch(err=>console.log(err))
  }
  renderCards=()=>{
    return this.state.dessous.map(course=>{
      return (
        <div className="card" style={{width: "30rem"}} key={course._id}>
          <div className="card-body">
            ...
            <p className="card-text">Dieser Dessous-Workshops wird von {course.teacher} durchgeführt.</p>
    ...
    return(
      <Dialog 
        ...
        TransitionComponent={Transition}>
          ...
          <DialogContent>
            <p>Dass du diesen Dessous-workshop löschen möchtest?</p>
          </DialogContent>
          <DialogActions>
    ...
    return (
      <div className="Home">
        <div className="page-title">
          <h1 className="page-title">Admin - Dessous</h1>
        </div>
        <div className="manage-container">
          <div className="card" style={{width: "30rem"}}>
            <div className="card-body">
            <h2><button onClick={this.selectMakeNew} className="btnHref">Neuen Dessous-Workshop erstellen</button></h2>
            </div>
          </div>
        </div>
...
export default withStyles(styles)(EditDessous);
